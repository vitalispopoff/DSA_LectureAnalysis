...
public class BinTreeQueuedTraversal_00{
...
//  --------------------------------------------------------------------------------------------------------------------
    ...
    public BinTreeQueuedTraversal_00() { }
...
//  --------------------------------------------------------------------------------------------------------------------
    ...
    BinTreeTraversalNode traverse() {
        ...
        while (queueLength > 0) {
            ...
            if (head.branchLeft != null)
                addToQueue(head.branchLeft);

            if (head.branchRight != null)
                addToQueue(head.branchRight);
    ...
    static class BinTreeTraversalNode implements Structured<BinTreeTraversalNode> {
        ...
        void addAsBranch(BinTreeTraversalNode node) {
            ...
            if (branchLeft == null)
                ...
                System.out.println("both branches are already there");
        }
