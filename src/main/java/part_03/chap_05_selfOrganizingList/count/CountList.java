...
public class CountList {
    ...
    public CountNode findElement(int element) {
        ...
        for (result = head;
             result != null && result.info != element;
             result = result.next
        ) ;
    ...
    boolean isPrevCounterMinor(CountNode node) {
        ...
        if (head == tail || node == head)
            ...
            return node.counter > node.prev.counter;
    }
    ...
    public List<Integer> toArray() {
        ...
        if (head == tail) {
            ...
            for (CountNode i = head;
                 i != null;
                 listing.add(i.info), i = i.next
            ) ;
