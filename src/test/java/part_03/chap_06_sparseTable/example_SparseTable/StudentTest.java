...
//    @Ignore
    ...
    public void unbindGrade_01() {
        ...
        Grade
                ...
                s1L3 = s1.gradeTail = L3.gradeHead = new Grade(3),
        ...
        Assert.assertTrue(s1L1 == L1.gradeHead);
        Assert.assertTrue(s1L1 == L1.gradeTail);
        Assert.assertNull(s1L1.nextStudentGrade);
        Assert.assertNull(s1L1.prevStudentGrade);

        // method tests
        s1.unbindGrade(s1L1, L1);
        Assert.assertNull(L1.gradeHead);
        Assert.assertNull(L1.gradeTail);
    }

    @Test
    public void unbindGrade_02() {
        ...
        Assert.assertTrue(s1L2 == L2.gradeHead);
        Assert.assertFalse(s2L2 == L2.gradeHead);
        Assert.assertTrue(s2L2 == L2.gradeTail);


        // method tests
        s2.unbindGrade(s2L2, L2);
        Assert.assertSame(s1L2, L2.gradeHead);
        Assert.assertSame(s1L2, L2.gradeTail);
    }


    @Test
    public void unbindGrade_03() {
