...
public class BinTreeQueuedTraversal00NodeTest {
    ...
    public void BinTreeTraverswalNode_01() {
        ...
        BinTreeQueuedTraversal_00.BinTreeTraversalNode node01 = new BinTreeQueuedTraversal_00.BinTreeTraversalNode(tree);
    ...
    public void addAsBranch_01() {
        BinTreeQueuedTraversal_00 tree = new BinTreeQueuedTraversal_00();
        BinTreeQueuedTraversal_00.BinTreeTraversalNode node01 = new BinTreeQueuedTraversal_00.BinTreeTraversalNode(tree);
        BinTreeQueuedTraversal_00.BinTreeTraversalNode node02 = new BinTreeQueuedTraversal_00.BinTreeTraversalNode(tree);
        BinTreeQueuedTraversal_00.BinTreeTraversalNode node03 = new BinTreeQueuedTraversal_00.BinTreeTraversalNode(tree);
